"use client"
import px from '../assets/images/3500px.png'
...
export const CallToAction = () => {
  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      ...
      <Image src={px} alt="px" className="size-40 absolute top-6 left-[calc(100%+36px)]" />
      </motion.div>
      <motion.div style={{translateY}}>
       
      <Image src={Dollar} alt="emoji" className="absolute -top-[120px] right-[calc(100%+30px)]" />
      </motion.div>
        ...
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          <input type="email" placeholder="ayalkbettesfahun@gmail.com" className="h-12 bg-white/20 rounded-lg px-5 font-medium placeholder:text-[#9CA3AF] sm:flex-1"/>
